    ...
    return (
        <Carousel responsive={responsive} swipeable draggable infinite autoPlay autoPlaySpeed={5000}>
            <div>
                ...
                <Container>
                    <h3>Nos missions</h3>
                    <Link href="/association" className='btn btn--primary'>Présentation de l'association <span></span></Link>
                </Container>
            </div>
            <div>
                ...
                <Container>
                    ...
                    <Link href="/chons" className='btn btn--primary'>Adoptez un de nos protégés <span></span></Link>
                </Container>
            </div>
            <div>
                ...
                <Container>
                    <h3>Faire un don</h3>
                    <Link href="/donate" className='btn btn--primary'>Nous aider <span></span></Link>
                </Container>
            </div>
        </Carousel>
    )
